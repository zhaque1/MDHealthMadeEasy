...
public class PicStoryThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pic_story_three);

        question1RG = findViewById(R.id.ch3_question1);
        question2RG = findViewById(R.id.ch3_question2);
        question3RG = findViewById(R.id.ch3_question3);

        submitBtn = findViewById(R.id.ch3_submitBtn);
