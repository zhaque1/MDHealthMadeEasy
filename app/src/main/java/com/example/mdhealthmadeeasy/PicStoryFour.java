...
public class PicStoryFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pic_story_four);

        question1RG= findViewById(R.id.ch4_question1);
        question2RG= findViewById(R.id.ch4_question2);
        question3RG= findViewById(R.id.ch4_question3);

        submitBtn=(Button)findViewById(R.id.ch4_submitBtn);
