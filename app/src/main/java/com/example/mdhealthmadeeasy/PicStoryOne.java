...
public class PicStoryOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pic_story_one);

        question1RG= findViewById(R.id.question1);
        question2RG= findViewById(R.id.question2);
        question3RG= findViewById(R.id.question3);
