...
public class PicStoryTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pic_story_two);

        question1RG= findViewById(R.id.ch2_question1);
        question2RG= findViewById(R.id.ch2_question2);
        question3RG= findViewById(R.id.ch2_question3);

        submitBtn=(Button)findViewById(R.id.ch2_submitBtn);
